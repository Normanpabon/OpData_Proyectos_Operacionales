...
CREATE TABLE proyecto(id int NOT NULL AUTO_INCREMENT, unidad_p int, fecha_reg DATE, fecha_fin DATE, desc_pro VARCHAR(128),id_estado int , observaciones VARCHAR(256), PRIMARY KEY(id), FOREIGN KEY (id_estado) REFERENCES estado(id));
...
INSERT INTO proyecto(unidad_p, fecha_reg, fecha_fin, desc_pro, id_estado) VALUES(
    1, '2022-10-05', '2022-12-05', "Proyecto No 1 prueba", 1
);

INSERT INTO proyecto(unidad_p, fecha_reg, fecha_fin, desc_pro, id_estado) VALUES(
    2, '2021-10-05', '2023-12-05', "Proyecto No 2 prueba", 2
);

INSERT INTO proyecto(unidad_p, fecha_reg, fecha_fin, desc_pro, id_estado) VALUES(
    2, '2020-10-05', '2024-12-05', "Proyecto No 3 prueba", 2
);

INSERT INTO proyecto(unidad_p, fecha_reg, fecha_fin, desc_pro, id_estado, observaciones) VALUES(
    4, '2022-10-05', '2022-12-05', "Proyecto No 4 prueba", 4, "Anulado por pruebas"
);