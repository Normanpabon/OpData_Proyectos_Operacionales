    ...
    <>
      ...
      >
        <div className={`${open ? "grid grid-cols-4 w-full" : ""}`}>
          ...
          {open ? (
            <p className="my-auto text-left col-span-3">Proyectos en Espera</p>
          ) : (
            ""
          )}
        </div>
      ...
      >
        <div className={`${open ? "grid grid-cols-4 w-full" : ""}`}>
          ...
          {open ? (
            <p className="my-auto text-left col-span-3">Todos los proyectos</p>
          ) : (
            ""
          )}
        </div>
      ...
      >
        <div className={`${open ? "grid grid-cols-4 w-full" : ""}`}>
          ...
          {open ? <p className="my-auto text-left col-span-3">Vencidos</p> : ""}
        </div>
      </label>
    </>
  );
